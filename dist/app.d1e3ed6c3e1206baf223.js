...
/* harmony default export */ __webpack_exports__["default"] = (`<div class="container is-fluid">
  <div class="columns">
    <div class="column is-half">
      <div class="title">All Datasets (Click to load)</div>
      <div id="list"></div>
    </div>
    <div class="column is-half">
      <div class="title">
        <button id="upload-new-dataset" class="button is-primary">
          Upload New Dataset
        </button>
      </div>
    </div>
...
class ElementView extends provenance_mvvm_framework__WEBPACK_IMPORTED_MODULE_0__["ViewBase"] {
    ...
    create() {
        ...
        this.ElementQueryDiv.append("div").html(_queryselection_view_html__WEBPACK_IMPORTED_MODULE_5__["default"]);
        ...
        tableVis.html(_queryresults_view_html__WEBPACK_IMPORTED_MODULE_4__["default"]);
    ...
    renderQueries(data) {
        ...
        ns.html(_newselection_view_html__WEBPACK_IMPORTED_MODULE_7__["default"]);
        ...
        aTags.html(_selection_view_html__WEBPACK_IMPORTED_MODULE_6__["default"]);
        let that = this;
...
__webpack_require__.r(__webpack_exports__);
// HTML
/* harmony default export */ __webpack_exports__["default"] = (`<div class="selection columns">
  <div class="column is-narrow">
    <i class="fa fa-square color-swatch">
  </i></div>
  <div class="column has-text-centered selection-text">24</div>
  <div class="column is-narrow">
...
__webpack_require__.r(__webpack_exports__);
// HTML
/* harmony default export */ __webpack_exports__["default"] = (`<div class="tag is-large is-white divider">
  <span class="icon">
    Query Results
    <i id="download-results" class="fas fa-download padding-left download-props"></i>
  </span>
</div>`);
...
__webpack_require__.r(__webpack_exports__);
// HTML
/* harmony default export */ __webpack_exports__["default"] = (`<aside class="menu">
  <ul class="menu-list">
    <li><a id="new-selection">Select an intersection</a></li>
  </ul>
  <p class="menu-label">
    Bookmarked Selections
  </p>
  <ul id="bookmarks" class="menu-list fix-height">
...
/* harmony default export */ __webpack_exports__["default"] = (`<div class="selection columns">
  ...
  <div class="column has-text-centered selection-text">24</div>
  <div class="column is-narrow">
    <i class="fas fa-plus-square is-invisible"></i>
    <i class="fas fa-times remove"></i>
  </div>
</div>`);
...
class FilterBoxView extends provenance_mvvm_framework__WEBPACK_IMPORTED_MODULE_2__["ViewBase"] {
    ...
    create() {
        d3__WEBPACK_IMPORTED_MODULE_1__["select"](this.Root).html(_filterbox_view_html__WEBPACK_IMPORTED_MODULE_4__["default"]);
        this.update();
    ...
    updateAggregationDropdowns() {
        ...
        firstAggByOptions
            ...
            .html(_radio_view_html__WEBPACK_IMPORTED_MODULE_5__["default"])
            .each(function (d) {
...
/* harmony default export */ __webpack_exports__["default"] = (`<div class="container is-fluid override is-size-7">
  ...
  <div class="accordions">
    <div id="firstAggByDropdown" class="accordion is-active">
      <div class="accordion-header toggle">
        Aggregation
      </div>
      <div class="accordion-body">
        <div class="accordion-content">
          <div id="firstAggByOptions" class="control">

          </div>

          <div id="firstoverlap-degree-input" class="field hidden">
    ...
    <div id="secondAgg">
      <div id="secondAggByDropdown" class="accordion">
        <div class="accordion-header toggle">
          Second Level Aggregation
        </div>
        <div class="accordion-body">
          <div class="accordion-content">
            <div id="secondAggByOptions" class="control">

            </div>

            <div id="secondoverlap-degree-input" class="field hidden">
              <label for="" class="label  is-size-7">Overlap Degree:</label>
    ...
    <div class="accordion is-capitalized">
      <div class="accordion-header toggle">
        Sorting
      </div>
      <div class="accordion-body">
    ...
    <div class="accordion is-capitalized">
      ...
      <div class="accordion-body">
        <div class="accordion-content">
          <div class="field">
            <label for="" class="label is-size-7">Show intersections with degree of</label>
            <div class="control">
            more than:  <input id="minDegree" type="number" class="input is-small">
            </div>
          </div>
          <div class="field">
                      <div class="control">
              less than: <input id="maxDegree" type="number" class="input is-small">
            </div>
          </div>
          <div class="field">
            <div class="control">
              <input id="hideEmpty" type="checkbox">
              <label class="checkbox is-size-7">Hide Empty Intersections</label>
            </div>
          </div>
        </div>
      </div>
...
__webpack_require__.r(__webpack_exports__);
// HTML
/* harmony default export */ __webpack_exports__["default"] = (`<label class="radio is-lowercase">
  <input type="radio">
  <span id="label" class="is-capitalized">Test</span>
</label>`);
...
/* harmony default export */ __webpack_exports__["default"] = (`<nav class="navbar is-dark" role="navigation" aria-label="main navigation">
  ...
  <div class="navbar-menu">
    ...
    <div class="navbar-end">
      ...
      <div class="navbar-item">
        <a id="load-data" class="button is-small">Load Data</a>
      </div>

      <div class="navbar-item">
        <div id="embed-modal">
          <a class="button is-small show">Embed</a>
        </div>
      </div>
...
function processFileUploadForm(inputForm, file, datasetInfo, firstCall = false) {
    ...
    if (firstCall) {
        ...
        submitBtn.on('click', () => {
            ...
            console.log(_app_app__WEBPACK_IMPORTED_MODULE_0__["serverUrl"]);
...
/* harmony default export */ __webpack_exports__["default"] = (`<div class="file-upload">
  <div class="columns is-vcentered">
    ...
    <div class="column input-form">
        ...
        <div class="control">
          ...
          <article class="message is-warning is-small">
            <div class="message-body">
              The uploaded dataset will be publicly available. If you want a
              private version, clone the repository and add your dataset to the
              data folder.
            </div>
          </article>
        </div>
      ...
      <div class="notification is-warning is-hidden"></div>
    </div>
  </div>
</div>
`);
...
/******/ });
//# sourceMappingURL=app.d1e3ed6c3e1206baf223.js.map