...
import { bookmarkedColorPalette, currentSelectionSelector, nextColorSelector } from './config/currentIntersectionAtom';
...
>({
  ...
  get: (id: string | null | undefined) => ({ get }) => {
    ...
    const currentIntersection = get(currentSelectionSelector);
