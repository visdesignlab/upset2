...
export const ErrorModal = () => {
  ...
  return (
    <Dialog open={true}>
      ...
      <DialogContent>
        <DialogContentText>
          The provided data is in an incompatible form for visualization with Upset. To
          visualize this dataset, please upload set-based data or, if compatible, select
