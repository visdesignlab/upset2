                ...
                <CardContent>
                    ...
                    <Box sx={{display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '100%', marginTop: '1em'}}>
                        <Card sx={{boxShadow: 4, borderRadius: "8px"}}>
                            <CardActionArea onClick={() => window.open('https://upset.multinet.app/?workspace=Upset+Examples&table=movies&sessionId=118')}>
                        ...
                        <Card sx={{boxShadow: 4, borderRadius: "8px"}}>
                            <CardActionArea onClick={() => window.open('https://upset.multinet.app/?workspace=Upset+Examples&table=simpsons&sessionId=119')}>
